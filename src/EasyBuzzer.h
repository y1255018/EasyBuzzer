...
class EasyBuzzerClass {
 public:
  ...
  /* Beep at a given frequency an specific number of times, with callback
   * functionality. */
  void beep(unsigned int frequency, unsigned int beeps,
            void (*finishedCallbackFunction)());
  /* Beep sequence at a given frequency. */
  void beep(unsigned int frequency, unsigned int const onDuration,
            unsigned int const offDuration, byte const beeps,
            unsigned int const pauseDuration, unsigned int const sequences);
  ...
  /* Beep at a given frequency, for an specific duration, with callback
   * functionality. */
  void singleBeep(unsigned int frequency, unsigned int duration,
                  void (*finishedCallbackFunction)());
  /* Stop beeping. */
